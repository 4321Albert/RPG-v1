...
(function() {
  ...
  const URL_API = "https://script.google.com/macros/s/AKfycbxB9eaMBuKURk1u0Zb8uWGgSyrZETBL_4KnBuOx5mvJdQ8bPkg1rdW8QB1gscRr7KVL/exec";
  const ServerActions = {
  ...
  // Override al guardado
    DataManager.saveGame = function(savefileId) {
        ...
        return fetch(URL_API, {
              redirect: "follow",
              method: "POST",
              body: JSON.stringify({ username, password, type: ServerActions.ACT_SAVE_GAME , save }),
              headers: {
