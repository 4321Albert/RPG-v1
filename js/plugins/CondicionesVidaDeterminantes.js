...
(function() {
    ...
    Object.defineProperty(window, '_contadorpuntosvida', {
        get: function() {
            return $gameVariables.value(163);
        },
        set: function(valor) {
            $gameVariables.setValue(163, valor);
        }
    });
    ...
    Game_System.prototype.juegoCompletadoo121213 = function() {
        return this._juegoCompletoo121213=== true;
    };

    Game_System.prototype.establecerjuegoCompletadoo121213 = function(estado) {
        this._juegoCompletoo121213= estado;
    };

    Game_System.prototype.juegoBloqueadoo121213= function() {
        return this._juegoBloqueadoo121213=== true;
    };

    Game_System.prototype.establecerBloqueoo121213= function(estado2) {
        this._juegoBloqueadoo121213= estado2;
    };
    ...
    Game_Interpreter.prototype.pluginCommand = function(comando, args) {
        ...
        if (comando === "CVD") {
            if ($gameSystem.juegoBloqueadoo121213()) {
                SceneManager.push(Escena_Bloqueooo121213);
                return;
            }
            
            if ($gameSystem.juegoCompletadoo121213()) {
                alert("Ya completaste este desafío con la máxima puntuación.");
                return;
            }
            // variable contador 2
            if ($gameVariables.value(164) === 0) {
                $gameVariables.setValue(164, 10) 
            }
            //contador 1
            if ($gameVariables.value(163) === 0) {
                $gameVariables.setValue(163, 10);
                
            }

            SceneManager.push(Scene_CVD);
        }
    };
    ...
    Scene_CVD.prototype = Object.create(Scene_Base.prototype);
    Scene_CVD.prototype.constructor = Scene_CVD;

    Scene_CVD.prototype.initialize = function() {
        Scene_Base.prototype.initialize.call(this);
    };

    Scene_CVD.prototype.create = function() {
    ...
    Scene_CVD.prototype.crearFondo = function() {
        this._fondo = new Sprite();
        const imagenFondo = ImageManager.loadBitmap('img/img_pluging/', 'condivida')
  ...
  Scene_CVD.prototype.createConsultaButton = function() {
  const buttonX = 225;  
  const buttonY = 50;  
  ...
  //funcion mostrar mas informacion 
Scene_CVD.prototype.createInfoButton = function() {
  ...
  Scene_CVD.prototype.createFinalScoreBox = function() {
  ...
  Scene_CVD.prototype.createScoreBox = function() {
  ...
  scoreBox.bitmap.drawText("Puntaje actividad: " + _contadorpuntosvida, 5, 5, 250, 40, 'left');


  this._scoreBox = scoreBox;
  this.addChild(scoreBox);
};
Scene_CVD.prototype.openConsultaWindow = function() {
  ...
  this.addChild(windowSprite);
      ...
      Scene_CVD.prototype.updateDragAndDrop = function() {
  ...
  Scene_CVD.prototype.resaltarCajasValidas = function(valor) {
  ...
  Scene_CVD.prototype.resetearResaltadoCajas = function() {
      for (const caja of this._cajas) {
          if (!caja._ocupada) {
              caja.bitmap.clear();
  ...
  Scene_CVD.prototype.update = function() {
  ...
  Scene_CVD.prototype.crearElementosDeTexto = function() {
  this._elements = [];
        
const variables = [ "Condicion","Tipo de determinante","Estrés emocional y tensiones familiares por la enfermedad​", "Uso de pesticidas sin control en la vereda La Paz", "5 de las 6 familias tiene barreras de acceso a servicios de salud","Presencia de vectores y criaderos de zancudos cerca de las viviendas, en todos los hogares menos en la Vereda La Paz","Falta de un programa de control vectorial por parte del municipio","Creencias en maldiciones y mitos","Ausencia de acueducto en todas las veredas","Malos hábitos alimenticios en general","Ocupaciones informales o rurales sin estabilidad (agricultores, arrieros, mineros)", "Proximal​", 'Intermedio', "Estructural"];
    ...
    Scene_CVD.prototype.crearElementosArrastrables = function() {
        this._elementos = [];
        
        const valores = ['1', '2', '3'];
        const posiciones = [
            {x: 665, y: 305}, {x: 665, y: 356}, {x: 665, y: 413},
    ...
    Scene_CVD.prototype.crearCajasDestino = function() {
        this._cajas = [];
        ...
        const posicionesCajas = [ 
            //Columna 1
            {x: 530, y: 190}, {x: 530, y: 225}, {x: 530, y: 260},
            {x: 530, y: 310}, {x: 530, y: 355}, {x: 530, y: 390},
            {x: 530, y: 425}, {x: 530, y: 460}, {x: 530, y: 500}
        ];

        for (let i = 0; i < 9; i++) {
            const caja = new Sprite(new Bitmap(70, 30));
    ...
    Scene_CVD.prototype.getBoxGroups = function() {
    return [
       '1',
       '2',
       '3',
      ...
      Scene_CVD.prototype.crearBotonesInferiores = function() {
        ...
        const y = TouchInput.y;
          if (TouchInput.isTriggered()) {
            if (x >= this.x && x <= this.x + this.width &&
                ...
                if (isValid) {
                _finalScore += _contadorpuntosvida;
                const currentVida = $gameVariables.value(4);
                $gameVariables.setValue(4, currentVida + _contadorpuntosvida);
                $gameSystem.establecerjuegoCompletadoo121213(true);
                ...
                alert("✅ Prueba correcta. Se sumaron " + _contadorpuntosvida + " puntos al resultado final.");
                } else {
                    //contador 2
                $gameVariables.setValue(164, $gameVariables.value(164) - 1);
                _contadorpuntosvida = Math.max(0, _contadorpuntosvida - 1);
                // Verificar si se acabaron los intentos
                if (_contadorpuntosvida <= 0 || $gameVariables.value(164) <= 0) {
                    $gameSystem.establecerBloqueoo121213(true);
                    SceneManager.push(Escena_Bloqueooo121213);
                    return;
                    }
                alert("❌ Respuestas incorrectas. Se restó 1 punto. Puntaje actual: " + _contadorpuntosvida);
                if (_contadorpuntosvida === 5) {
            ...
            if (self._scoreBox) {
              ...
              self._scoreBox.bitmap.drawText("Puntaje: " + _contadorpuntosvida, 0, 0, 250, 40, 'left');
    ...
    Scene_CVD.prototype.validarRespuestas = function() {
    ...
    function Escena_Bloqueooo121213() {
        this.initialize.apply(this, arguments);
    }
      ...
      Scene_CVD.prototype.tryDrop = function(elementoArrastrable) {
  ...
  Scene_CVD.prototype.obtenerColorSegunTipo = function(valor) {
      // Colores diferentes para números vs porcentajes
      return valor.includes('%') ? '#f2f4f6ff' : '#fbf9f8ff';
  };

  Scene_CVD.prototype.crearEfectoSoltado = function(x, y) {
  ...
  //Metodo de validacion 
    Scene_CVD.prototype.checkAllBoxesFilled = function() {
    ...
    Scene_CVD.prototype.checkAllAnswers = function() {
  ...
  Escena_Bloqueooo121213.prototype = Object.create(Scene_Base.prototype);
  Escena_Bloqueooo121213.prototype.constructor = Escena_Bloqueooo121213;

  Escena_Bloqueooo121213.prototype.initialize = function() {
    Scene_Base.prototype.initialize.call(this);
  };

  Escena_Bloqueooo121213.prototype.create = function() {
    Scene_Base.prototype.create.call(this);
    // Mostrar imagen de fondo
    this._bg = new Sprite();
    const bgBitmap = ImageManager.loadBitmap('img/img_pluging/', 'cvds', false);
  ...
  DataManager.makeSaveContents = function() {
    ...
    contents._contadorpuntosvida = _contadorpuntosvida;
    contents._finalScore = _finalScore;
    contents._juegoBloqueadoo121213= $gameSystem.juegoBloqueadoo121213();
    return contents;
  };
  ...
  DataManager.extractSaveContents = function(contents) {
    ...
    _contadorpuntosvida = contents._contadorpuntosvida || 0;
    _finalScore = contents._finalScore || 0;
    $gameSystem.establecerBloqueoo121213(contents._juegoBloqueadoo121213|| false);
  };
